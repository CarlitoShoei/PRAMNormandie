...
echo simpleDisplaySelect($listObs, 'C_OBSV', 'ID', 'OBS_NOM_PRENOM', 0, '', 22); ?>             <img src="../img/observateur_add.png" alt="Ajouter un observateur" title="Ajouter un observateur" width="20" onClick="load_page('observateurs/observateurs_especefauneflore.php?ID_STRUCTURE=<?php echo  $S_ID;?>', 'observateur', 'observateur')"/>