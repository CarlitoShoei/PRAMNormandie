						...
						<table align="center" border="0">
							<tr>
								<td width="30" align="center">
									<img src="../img/delete.png" width="20" Title="Fermer" OnClick="afficher_masquer('observateur','affichage_vide.php');load_page('observateurs/actualise_observateur.php?S_ID=<?php echo $S_ID ?>','actualiser_observateur', 'actualiser_observateur')">
								</td>
							</tr>
						</table>
					</fieldset>
