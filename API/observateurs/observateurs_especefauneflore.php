						...
						<table align="center" border="0">
							<tr>
								<td width="30" align="center">
									<img src="../img/delete.png" width="20" Title="Fermer" OnClick="afficher_masquer('observateur','affichage_vide.php');load_page('observateurs/actualise_observateurfauneflore.php?S_ID=<?php echo $S_ID ?>','actualise_observateurfauneflore', 'actualise_observateurfauneflore')">
								</td>
							</tr>
						</table>
					</fieldset>
