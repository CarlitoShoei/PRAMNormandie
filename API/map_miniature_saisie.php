...
?>
<input style="display:none" id="longitude" type="text" value="<?php echo $longitude ?>">
<input style="display:none" id="latitude" type="text" value="<?php echo $latitude ?>">
<div id="mapminiature">
...
<script type="text/javascript" src="js/leaflet/leaflet.js"></script>
	...
	<script type="text/javascript" src="js/init_leaflet_miniature_saisie.js"></script>