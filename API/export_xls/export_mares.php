	...
	$worksheet->write("P".$x,utf8_decode(rtrim($resultat['L_VALID'], " & ")));
		...
		while($resultat_carac = pg_fetch_array($req_filtre_carac)){
			...
			// }
				...
				$req_filtre_patrimoine =  pg_query($bdd, 'SELECT saisie_observation.caracterisation_patrimoine."ID_CARAC", menu_deroulant.c_patrimoine."PATRIMOINE", saisie_observation.caracterisation_alimentation."PATRIMOINE_AUTRE"
